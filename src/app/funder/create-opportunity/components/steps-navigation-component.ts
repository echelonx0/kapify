// src/app/funder/create-opportunity/components/opportunity-steps-navigation.component.ts
...
@Component({
  ...
  template: `
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6 sticky top-6">
      ...
      <!-- Completion Summary -->
      @if (progressPercentage() === 100 && !organizationError()) {
...
export class OpportunityStepsNavigationComponent {
  ...
  progressPercentage = this.stepNavigation.progressPercentage;
