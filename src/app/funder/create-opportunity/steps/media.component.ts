...
import { LucideAngularModule, Sparkles, Eye, Users, Settings, Lightbulb, AlertCircle } from 'lucide-angular';
    ...
    <div class="space-y-2 mt-8">
      ...
      <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
        <div class="flex items-start space-x-3">
          <lucide-angular [img]="LightbulbIcon" [size]="20" class="text-blue-600 mt-0.5"></lucide-angular>
          <div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="space-y-2">
          <label class="block text-sm font-semibold text-gray-700 flex items-center">
            <lucide-angular [img]="EyeIcon" [size]="16" class="mr-2"></lucide-angular>
            Opportunity Image URL
          </label>
          <input 
            type="url" 
          ...
          @if (formState.formData().fundingOpportunityImageUrl && !formState.getFieldError('fundingOpportunityImageUrl')) {
        ...
        <div class="space-y-2">
          <label class="block text-sm font-semibold text-gray-700 flex items-center">
            <lucide-angular [img]="SparklesIcon" [size]="16" class="mr-2"></lucide-angular>
            Opportunity Video URL
          </label>
          <input 
            type="url" 
        ...
        <div class="space-y-2">
          <label class="block text-sm font-semibold text-gray-700 flex items-center">
            <lucide-angular [img]="SettingsIcon" [size]="16" class="mr-2"></lucide-angular>
            Organization Logo URL
          </label>
          <input 
            type="url" 
          ...
          @if (formState.formData().funderOrganizationLogoUrl && !formState.getFieldError('funderOrganizationLogoUrl')) {
            <div class="mt-2 p-2 bg-gray-50 rounded border">
              <img 
