...
export class FunderHeaderComponent {
  ...
  private funderRouteConfigs: Record<string, FunderRouteConfig> = {
    '/funder': {
      ...
      description:
        'Manage your funding opportunities, review applications, and track your funding portfolio.',
    ...
    '/funder/onboarding': {
      ...
      description:
        'Complete your organization setup to start creating funding opportunities.',
      breadcrumbs: [
    ...
    '/funder/onboarding/welcome': {
      ...
      description:
        'Get started with setting up your organization profile and verification.',
      breadcrumbs: [
        { label: 'Dashboard', path: '/funder/dashboard' },
    ...
    '/funder/onboarding/organization-info': {
      ...
      description:
        'Provide basic information about your organization, including name, type, and contact details.',
      breadcrumbs: [
        { label: 'Dashboard', path: '/funder/dashboard' },
        { label: 'Onboarding', path: '/funder/onboarding' },
    ...
    '/funder/onboarding/legal-compliance': {
      ...
      description:
        'Complete your legal information, registration details, and compliance requirements.',
      breadcrumbs: [
        { label: 'Dashboard', path: '/funder/dashboard' },
        { label: 'Onboarding', path: '/funder/onboarding' },
    ...
    '/funder/onboarding/verification': {
      title: 'Verification',
      description:
        'Review your information and submit for verification to activate your funder account.',
      breadcrumbs: [
        { label: 'Dashboard', path: '/funder/dashboard' },
        { label: 'Onboarding', path: '/funder/onboarding' },
        { label: 'Verification' },
    ...
    '/funder/create-profile': {
      ...
      description:
        'Create and manage your public funder profile to attract quality applications.',
      breadcrumbs: [
        { label: 'Dashboard', path: '/funder/dashboard' },
    ...
    '/funder/opportunities/import': {
      ...
      description:
        'Import funding opportunities from external sources or templates.',
      breadcrumbs: [
        { label: 'Dashboard', path: '/funder/dashboard' },
    ...
    '/funder/opportunities/create': {
      ...
      description:
        'Create a new funding opportunity to attract applications from SMEs.',
      breadcrumbs: [
        { label: 'Dashboard', path: '/funder/dashboard' },
        { label: 'Opportunities', path: '/funder/opportunities' },
        { label: 'Create' },
  ...
  currentRouteConfig = computed(() => {
    ...
    if (
      currentPath.includes('/funder/opportunities/') &&
      currentPath.includes('/applications')
    ) {
      return {
        title: 'Application Management',
        description:
          'Review and manage applications for your funding opportunity.',
        breadcrumbs: [
          { label: 'Dashboard', path: '/funder/dashboard' },
          { label: 'Opportunities', path: '/funder/opportunities' },
          { label: 'Applications' },
    ...
    if (currentPath.match(/\/funder\/opportunities\/[^\/]+$/)) {
      return {
        ...
        description:
          'View and manage your funding opportunity details and settings.',
        breadcrumbs: [
          { label: 'Dashboard', path: '/funder/dashboard' },
          { label: 'Opportunities', path: '/funder/opportunities' },
          { label: 'Details' },
    ...
    if (currentPath.match(/\/funder\/applications\/[^\/]+$/)) {
      return {
        ...
        description:
          'Review application details, documents, and make funding decisions.',
        breadcrumbs: [
          { label: 'Dashboard', path: '/funder/dashboard' },
  ...
  constructor() {
    if (!this.currentUser()) {
      this.profileService.loadProfileData().subscribe({
        error: (error) => {
          console.error(
            'Failed to load user profile for funder header:',
            error
          );
        },
      });
