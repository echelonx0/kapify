...
import { OpportunityFormStateService } from '../../create-opportunity/services/opportunity-form-state.service';
  ...
  template: `
    <div class="space-y-6">
          ...
          <label class="flex items-start space-x-3 cursor-pointer">
            ...
            <div>
              ...
              <p class="text-sm text-gray-600">
                Make this opportunity visible to all qualified SMEs on the
                platform
              </p>
            </div>
          </label>
      ...
      <div class="space-y-4">
        ...
        <div class="space-y-2">
          <label class="block text-sm font-semibold text-gray-700"
            >Maximum Applications</label
          >
          <input
            type="text"
            placeholder="No limit"
            [value]="
              ui.formatNumberWithCommas(formState.formData().maxApplications)
            "
          ...
          <p class="text-xs text-gray-500">
            Leave blank to allow unlimited applications
          </p>
          }
        </div>
      </div>
        ...
        <div class="flex items-start space-x-3">
          ...
          <div>
            ...
            <p class="text-sm text-green-700 mt-1">
              These settings help you control the application flow. You can
              always adjust them later, and we'll notify applicants of any
