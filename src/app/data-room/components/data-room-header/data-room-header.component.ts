...
export class DataRoomHeaderComponent {
  ...
  @Input() stats: { totalViews: number; totalDownloads: number; uniqueViewers: number; activeShares?: number } | null = null;
  @Input() shareInfo: { expiresAt?: Date; permissionLevel?: string } | null = null;
