...
export const dashboardRoutes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'funding-opportunities', loadComponent: () => import('../funding/funding-opportunities/opportunities-list/funding-opportunities.component').then(c => c.FundingOpportunitiesComponent) },
