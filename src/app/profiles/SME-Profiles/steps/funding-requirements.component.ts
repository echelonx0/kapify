...
import { SMEProfileStepsService } from '../../../SMEs/services/sme-profile-steps.service';
    ...
    <div class="space-y-8">
      <div class="text-center">
        ...
        <p class="text-neutral-600 mt-2">
          Tell us about your funding needs to match you with the right investors
        </p>
      </div>
      ...
      <ui-card>
        <form [formGroup]="fundingForm" class="space-y-8">
          ...
          <div class="space-y-4">
            ...
            <div>
              <label class="block text-sm font-medium text-neutral-700 mb-2"
                >Preferred Repayment Period</label
              >
              <select
              ...
              <div class="flex items-start space-x-3">
                ...
                <div class="flex-1">
                  ...
                  <p class="text-xs text-neutral-500 mt-1">
                    Collateral can include property, equipment, inventory, or
...
export class FundingRequirementsComponent implements OnInit {
  ...
  constructor(
    ...
    this.fundingForm
      ...
      ?.valueChanges.subscribe((hasCollateral) => {
