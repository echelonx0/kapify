...
// import { OrganizationService } from '../../../services/fetch-organization.service';
...
//   label: string;
//   category: 'company' | 'contact' | 'funding' | 'funder' | 'system';
//   width?: number;
// }
...
//                       class="text-xs px-2.5 py-1 rounded-full bg-teal-50 text-teal-700 font-semibold"
//                     >
//                       {{ funderFieldsSelected() }}/{{ funderFields().length }}
//                     </span>
//                   </div>
//                   <lucide-angular
//                     [img]="ChevronIcon"
//                     size="18"
//                     class="text-slate-600 transition-transform duration-200"
//                     [class.rotate-180]="isSectionOpen('funder')"
//                   ></lucide-angular>
//                 </button>

//                 @if (isSectionOpen('funder')) {
//                 <div
//                   class="px-6 py-4 space-y-3 border-t border-slate-200 bg-white"
//                 >
//                   @for (field of funderFields(); track field.key) {
//                   <label
//                     class="flex items-center gap-3 px-3 py-2.5 border border-slate-200 rounded-lg cursor-pointer hover:bg-slate-50 transition-colors"
//                     [class.bg-teal-50]="isFieldSelected(field.key)"
//                     [class.border-teal-300]="isFieldSelected(field.key)"
...
//   @Input() funderId: string | null = null;
...
//     new Set(['company', 'contact', 'funding', 'funder', 'system'])
//   );
//   funderName = signal<string>('');
...
//   );
//   funderFields = computed(() =>
//     this.allFields.filter((f) => f.category === 'funder')
//   );
...
//         .length
//   );
//   funderFieldsSelected = computed(
//     () =>
//       this.funderFields().filter((f) => this.selectedFields().has(f.key)).length
//   );
...
//     if (this.funderId) {
//       const name = await this.orgService.getFunderName(this.funderId);
//       this.funderName.set(name);
//     }
