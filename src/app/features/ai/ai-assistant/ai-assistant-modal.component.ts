  ...
  availableActions: AIAction[] = [
    {
      ...
      description:
        'Comprehensive AI analysis of the application documents, financial projections, and business model.',
    ...
    },
    {
      ...
      description:
        'Verify founder credentials, check credit history, and analyze professional backgrounds.',
      icon: this.UsersIcon,
    ...
    },
    {
      ...
      description:
        'Live market data analysis, competitive landscape assessment, and growth opportunity evaluation.',
    ...
    },
    {
      ...
      description:
        'Comprehensive risk analysis including financial, operational, and market risks.',
