    ...
    >
      ...
      >
        ...
        <div class="px-6 py-6">
          ...
          <div
            class="flex gap-3 p-3 rounded-lg bg-green-50 border border-green-100 mb-4"
          >
            <lucide-icon
              [img]="CheckCircleIcon"
              size="20"
            ...
            <div>
              ...
              <p class="text-sm text-green-700 mt-1">
                Your opportunity is now live and visible to businesses.
              </p>
            </div>
          </div>
          ...
          <!-- Publish Error State -->
          <div
            class="flex gap-3 p-3 rounded-lg bg-red-50 border border-red-100 mb-4"
          >
            <lucide-icon
              [img]="AlertCircleIcon"
              size="20"
          ...
          >
            ...
            <div>
              ...
              <p class="text-sm text-red-700 mt-1">
                {{ modalService.errorMessage() }}
              </p>
            </div>
          </div>
          } @else { @switch (modalService.actionType()) { @case ('delete') {
          <div
            class="flex gap-3 p-3 rounded-lg bg-amber-50 border border-amber-100 mb-4"
          >
            <lucide-icon
              [img]="AlertCircleIcon"
              size="20"
          ...
          @if (modalService.data().hasApplications &&
          modalService.data().applicationCount! > 0) {
          <div
            class="flex gap-3 p-3 rounded-lg bg-blue-50 border border-blue-100"
          >
            <span class="text-sm text-blue-900">
              <strong
                >{{ modalService.data().applicationCount }} active
          ...
          <div
            class="flex gap-3 p-3 rounded-lg bg-green-50 border border-green-100"
          >
            <lucide-icon
              [img]="CheckCircleIcon"
              size="20"
        ...
        <div class="px-6 py-6 border-t border-gray-100 bg-gray-50 flex gap-3">
          ...
          @if (modalService.actionType() === 'publish-success' ||
          modalService.actionType() === 'publish-error') {
          <button
            type="button"
          ...
          >
            {{
              modalService.actionType() === 'publish-success'
                ? 'View Opportunity'
                : 'Got it'
            }}
          </button>
...
export class OpportunityActionModalComponent {
  ...
  private playSound() {
    ...
    // Subtle double-tone chime: 440Hz → 550Hz
