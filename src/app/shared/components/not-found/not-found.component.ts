  ...
  template: `
    <div class="min-h-screen bg-gradient-to-br from-neutral-50 to-neutral-100 flex items-center justify-center px-4">
      <div class="max-w-lg w-full text-center">
        ...
        <div class="mb-8">
          ...
          <div class="relative -mt-8">
            <div class="absolute inset-0 flex items-center justify-center">
              <lucide-icon [img]="SearchIcon" [size]="48" class="text-neutral-400"></lucide-icon>
            </div>
          </div>
        </div>
        ...
        <!-- Error Message -->
        <div class="mb-8">
          <h2 class="text-2xl font-bold text-neutral-900 mb-3">Page Not Found</h2>
        ...
        <div class="space-y-4">
          ...
          >
            <lucide-icon [img]="ArrowLeftIcon" [size]="20" class="mr-2"></lucide-icon>
            Go Back
          </button>
          ...
          >
            <lucide-icon [img]="HomeIcon" [size]="20" class="mr-2"></lucide-icon>
            Go to Dashboard
          </a>
        </div>
        ...
        <div class="mt-8 pt-6 border-t border-neutral-200">
          <p class="text-sm text-neutral-500">
            Need help? 
            <a href="mailto:support@kapify.co.za" class="text-primary-600 hover:text-primary-700 font-medium">
              Contact support
            </a>
          </p>
        </div>
