    ...
    <div class="card-gradient mt-6">
      ...
      >
        ...
        <div class="absolute inset-0 opacity-10">
          <div
            class="absolute inset-0 bg-[url('data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iNDAiIGhlaWdodD0iNDAiIHZpZXdCb3g9IjAgMCA0MCA0MCIgZmlsbD0ibm9uZSIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj4KPGNpcmNsZSBjeD0iMjAiIGN5PSIyMCIgcj0iMiIgZmlsbD0iIzAwMCIgZmlsbC1vcGFjaXR5PSIwLjEiLz4KPC9zdmc+')]"
          ></div>
        </div>
        ...
        <div class="relative z-10">
          ...
          <div *ngIf="isSubscribed()" class="text-center py-8">
            <div
              class="inline-flex items-center justify-center w-16 h-16 bg-green-500/20 backdrop-blur-sm rounded-2xl mb-4"
            >
              <lucide-icon
                [img]="CheckCircleIcon"
                [size]="28"
          ...
          <div *ngIf="!isSubscribed()" class="space-y-4 mb-6">
            ...
            >
              ...
              <span *ngIf="!isSubmitting()"> Get Access </span>
            </button>
          </div>
