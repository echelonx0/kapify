...
//    return this.sectionStates()[sectionId as keyof typeof this.sectionStates] || false;
//  }

//  toggleSection(sectionId: string) {
//    this.sectionStates.update(current => ({
//      ...current,
//      [sectionId]: !current[sectionId as keyof typeof current]
//    }));
//  }
