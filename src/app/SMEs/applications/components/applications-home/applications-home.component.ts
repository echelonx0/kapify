...
//               this.transformFunderApplication(app)
//             );
...
//           console.log(smeApplications, `Loaded ${smeApplications.at}`);
//           const applicationData = smeApplications.map((app) =>
//             this.transformSMEApplication(app)
//           );
//           this.applications.set(this.mergeDrafts(applicationData));
//           this.isLoading.set(false);
//         },
...
//   private transformSMEApplication(
