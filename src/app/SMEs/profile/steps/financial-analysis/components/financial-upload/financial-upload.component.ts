...
import { LucideAngularModule, Upload, Download, FileSpreadsheet, CheckCircle, AlertCircle, X } from 'lucide-angular';
import { ParseProgress } from 'src/app/SMEs/profile/services/excel-parser.service';
import { UiCardComponent, UiButtonComponent } from 'src/app/shared/components';

@Component({
  selector: 'app-financial-upload',
  standalone: true,
  imports: [CommonModule, UiCardComponent, UiButtonComponent, LucideAngularModule],
  template: `
          ...
          <div class="text-center">
            ...
            <div class="mb-6">
              ...
              <p class="text-sm text-gray-500 mt-2">
                Use <strong>this template</strong> with predefined columns and rows to fill in the dataset.
              </p>
            </div>
                ...
                <div>
                  ...
                  @if (isValidTemplate()) {
                    <p class="text-sm text-primary-600">
                      ✓ Template structure validated • {{ completionPercentage() }}% complete
                    </p>
                  }
                </div>
              </div>
