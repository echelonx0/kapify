...
//             @for (area of getDisplayFocusAreas(); track area) {
//               <span
...
//   private readonly DEFAULT_FOCUS_AREAS = ['Equity', 'Investments'];
...
//   getDisplayFocusAreas(): string[] {
//     console.log(
//       '🔍 Org:',
//       this.profile.organizationName,
//       '| fundingAreas:',
//       this.profile.fundingAreas,
//     );

//     if (!this.profile.fundingAreas || this.profile.fundingAreas.length === 0) {
//       console.log('✅ Using defaults: Equity, Investments');
//       return this.DEFAULT_FOCUS_AREAS;
//     }

//     const areas = this.profile.fundingAreas
//       .slice(0, 2)
//       .map((area) => area.name);
//     console.log('📍 Using profile areas:', areas);
//     return areas;
//   }
  ...
  template: `
    ...
    >
      ...
      <div class="p-8">
        <!-- Name -->
        <h3
          class="text-xs font-black text-white mb-2 line-clamp-2 group-hover:text-emerald-400 transition-colors"
        >
          {{ profile.organizationName }}
        </h3>
