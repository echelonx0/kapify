...
@Component({
  ...
  template: `
    @if (profile) {
    <section
      class="relative overflow-hidden bg-slate-950 pt-20 pb-0 min-h-screen flex items-center"
    >
      ...
      <div class="relative max-w-7xl mx-auto px-6 w-full">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-stretch">
          ...
          <div class="relative lg:py-0 py-12">
            ...
            <!-- Proof points -->
            @if (profile && profile.portfolioHighlights &&
            ...
            >
              @for (highlight of profile.portfolioHighlights.slice(0, 2); track
              highlight) {
...
export class FunderHeroEnhancedComponent implements OnInit, OnDestroy {
