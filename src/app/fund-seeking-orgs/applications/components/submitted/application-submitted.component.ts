    ...
    <div class="min-h-screen bg-gray-50">
      <div class="max-w-4xl mx-auto px-4 py-8">
        ...
        <div class="text-center py-16">
          <div
            class="w-16 h-16 bg-blue-100 rounded-full mx-auto mb-6 flex items-center justify-center"
          >
            <lucide-icon
              [img]="ClockIcon"
              [size]="24"
        ...
        <div class="space-y-8">
          ...
          <div class="text-center">
            <div
              class="w-20 h-20 bg-green-100 rounded-full mx-auto mb-6 flex items-center justify-center"
            >
              <lucide-icon
          ...
          <ui-card class="overflow-hidden">
            <div
              class="bg-gradient-to-r from-blue-600 to-indigo-700 px-8 py-6 text-white"
            >
                ...
                <div class="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p class="text-sm text-gray-600">
                      {{ formatDate(submissionResult()?.submittedAt) }}
                    </p>
                  </div>
                </div>
              ...
              <div class="space-y-6">
                <div class="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p class="text-gray-600">
                      Your application will undergo an initial eligibility and
                      completeness check within 2-3 business days.
                    </p>
                  </div>
                </div>
                ...
                <div class="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p class="text-gray-600">
                      Our review committee will evaluate your application
                      against the funding criteria and business case.
                    </p>
                  </div>
                </div>
                ...
                <div class="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p class="text-gray-600">
                      You'll receive a decision notification via email within
            ...
            <div class="px-8 py-6">
              <div class="flex items-start space-x-3">
                <lucide-icon
                  ...
                  [size]="20"
                  class="text-amber-600 flex-shrink-0 mt-1"
                />
                <div>
                  ...
                  <ul class="space-y-2 text-sm text-amber-800">
                    ...
                    <li class="flex items-start space-x-2">
                      ...
                      ></div>
                      <span
                        >Monitor your email regularly for updates and requests
                        from our review team</span
                      >
                    </li>
                    <li class="flex items-start space-x-2">
                      <div
