...
export const applicationRoutes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadComponent: () =>
          import(
            './components/applications-home/applications-home.component'
          ).then((c) => c.ApplicationsHomeComponent),
      ...
      },
      {
        path: 'submitted',
        loadComponent: () =>
          import('./components/submitted/application-submitted.component').then(
            (m) => m.ApplicationSubmittedComponent
          ),
