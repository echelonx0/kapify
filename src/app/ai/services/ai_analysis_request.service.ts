...
export class AiAnalysisRequestService {
    ...
    try {
      const { data, error } = await this.supabase
        .rpc('record_ai_analysis_request', {
          ...
          application_id_param: applicationId || null,
          opportunity_id_param: opportunityId || null,
        })
        .single();
      ...
      console.log(
        `✅ [AI Analysis] Request created: ${data} (free: ${isFree}, appId: ${applicationId}, oppId: ${opportunityId})`
      );
   ...
   * @param analysisType Type of analysis: 'profile' or 'opportunity' (default: 'comprehensive')
   */
